...
const Post = () => {
  ...
  const [formData, setFormData] = useState({ branch_id: '', dept_id: '', post_name: '', is_active: '' });
  ...
  const handleClose = () => {
    setShow(false);
    setFormData({ branch_id: '', dept_id: '', post_name: '', is_active: '' });
    setEditingId(null);
  };
  ...
  const handleEdit = (item) => {
    setFormData({ branch_id: item.branch_id || '', dept_id: item.dept_id || '', post_name: item.post_name || '', is_active: item.is_active || '' });
