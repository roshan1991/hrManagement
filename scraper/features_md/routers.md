...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/routers](https://digitalhr.cyclonenepal.com/admin/routers)
...
- `models/routers.js` or equivalent
- `controllers/routersController.js`
- `routes/routers.js`
- `views/routers/index.html` (or React/Vue components)
