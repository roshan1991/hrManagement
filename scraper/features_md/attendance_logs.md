...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/attendance/logs](https://digitalhr.cyclonenepal.com/admin/attendance/logs)
...
- `models/attendance_logs.js` or equivalent
- `controllers/attendance_logsController.js`
- `routes/attendance_logs.js`
- `views/attendance_logs/index.html` (or React/Vue components)
