...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/employee-salaries/tax-report](https://digitalhr.cyclonenepal.com/admin/employee-salaries/tax-report)
...
- **Include SSF** (`year`, type: select)
- **Include SSF** (`branch_id`, type: select)
- **Include SSF** (`department_id`, type: select)
- **Include SSF** (`employee_id`, type: select)
...
- `models/tax_report.js` or equivalent
- `controllers/tax_reportController.js`
- `routes/tax_report.js`
- `views/tax_report/index.html` (or React/Vue components)
