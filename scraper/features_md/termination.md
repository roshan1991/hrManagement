...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/termination](https://digitalhr.cyclonenepal.com/admin/termination)
...
- **Termination Type** (`termination_type_id`, type: select)
- **Notice Date** (`notice_date`, type: date)
- **Termination Date** (`termination_date`, type: date)
...
- `models/termination.js` or equivalent
- `controllers/terminationController.js`
- `routes/termination.js`
- `views/termination/index.html` (or React/Vue components)
