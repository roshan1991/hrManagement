...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/roles](https://digitalhr.cyclonenepal.com/admin/roles)
...
- **Role Name** (`name`, type: text)
- **Authorize Backend Login** (`backend_login_authorize`, type: select)
- **Authorize Backend Login** (`is_active`, type: select)
...
- `models/roles___permissions.js` or equivalent
- `controllers/roles___permissionsController.js`
- `routes/roles___permissions.js`
- `views/roles___permissions/index.html` (or React/Vue components)
