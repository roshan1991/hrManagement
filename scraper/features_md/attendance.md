...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/attendances](https://digitalhr.cyclonenepal.com/admin/attendances)
...
- **attendance_date** (`attendance_date`, type: date)
- **branch_id** (`branch_id`, type: select)
- **department_id** (`department_id`, type: select)
- **Check In At** (`check_in_at`, type: time)
- **Check In At** (`check_out_at`, type: time)
- **Check In At** (`edit_remark`, type: textarea)
- **Check In At** (`night_checkin`, type: datetime-local)
- **Check Out At** (`night_checkout`, type: datetime-local)
...
- `models/attendance.js` or equivalent
- `controllers/attendanceController.js`
- `routes/attendance.js`
- `views/attendance/index.html` (or React/Vue components)
