...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/nfc](https://digitalhr.cyclonenepal.com/admin/nfc)
...
- `models/nfc.js` or equivalent
- `controllers/nfcController.js`
- `routes/nfc.js`
- `views/nfc/index.html` (or React/Vue components)
