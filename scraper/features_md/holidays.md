...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/holidays](https://digitalhr.cyclonenepal.com/admin/holidays)
...
- **Event Date** (`event_date`, type: date)
- **Is Public Holiday?** (`is_public_holiday`, type: select)
...
- `models/holidays.js` or equivalent
- `controllers/holidaysController.js`
- `routes/holidays.js`
- `views/holidays/index.html` (or React/Vue components)
