...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/recruitment/onboard/list](https://digitalhr.cyclonenepal.com/admin/recruitment/onboard/list)
...
- `models/onboard.js` or equivalent
- `controllers/onboardController.js`
- `routes/onboard.js`
- `views/onboard/index.html` (or React/Vue components)
