...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/showQR](https://digitalhr.cyclonenepal.com/admin/showQR)
...
- `models/app_qr.js` or equivalent
- `controllers/app_qrController.js`
- `routes/app_qr.js`
- `views/app_qr/index.html` (or React/Vue components)
