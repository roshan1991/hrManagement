...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/transfer](https://digitalhr.cyclonenepal.com/admin/transfer)
...
- **Branch** (`old_branch_id`, type: select)
- **Department** (`old_department_id`, type: select)
- **Employee** (`employee_id`, type: select)
- **Post** (`old_post_id`, type: select)
- **Supervisor** (`old_supervisor_id`, type: select)
- **Office Time** (`old_office_time_id`, type: select)
- **Branch** (`branch_id`, type: select)
- **Department** (`department_id`, type: select)
- **Post** (`post_id`, type: select)
- **Supervisor** (`supervisor_id`, type: select)
- **Office Time** (`office_time_id`, type: select)
- **Transfer Date** (`transfer_date`, type: date)
...
- `models/transfer.js` or equivalent
- `controllers/transferController.js`
- `routes/transfer.js`
- `views/transfer/index.html` (or React/Vue components)
