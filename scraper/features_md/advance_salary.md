...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/advance-salaries](https://digitalhr.cyclonenepal.com/admin/advance-salaries)
...
- `models/advance_salary.js` or equivalent
- `controllers/advance_salaryController.js`
- `routes/advance_salary.js`
- `views/advance_salary/index.html` (or React/Vue components)
