...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/logout](https://digitalhr.cyclonenepal.com/admin/logout)
...
- `models/log_out.js` or equivalent
- `controllers/log_outController.js`
- `routes/log_out.js`
- `views/log_out/index.html` (or React/Vue components)
