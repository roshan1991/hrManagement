...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/complaint](https://digitalhr.cyclonenepal.com/admin/complaint)
...
- **Branch** (`branch_from`, type: select)
- **Department** (`department_from`, type: select)
- **Complaint From** (`complaint_from`, type: select)
- **Branch** (`branch_id`, type: select)
- **Department** (`department_id[]`, type: select)
- **Complain To** (`employee_id[]`, type: select)
- **Subject** (`subject`, type: text)
- **Image** (`image`, type: file)
- **Image** (`message`, type: textarea)
...
- `models/complaint.js` or equivalent
- `controllers/complaintController.js`
- `routes/complaint.js`
- `views/complaint/index.html` (or React/Vue components)
