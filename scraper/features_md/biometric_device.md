...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/biometric-devices](https://digitalhr.cyclonenepal.com/admin/biometric-devices)
...
- **Name** (`name`, type: text)
- **Serial Number** (`serial_number`, type: text)
...
- `models/biometric_device.js` or equivalent
- `controllers/biometric_deviceController.js`
- `routes/biometric_device.js`
- `views/biometric_device/index.html` (or React/Vue components)
