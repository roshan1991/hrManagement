...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/recruitment/recommendation-type](https://digitalhr.cyclonenepal.com/admin/recruitment/recommendation-type)
...
- `models/recommendation_type.js` or equivalent
- `controllers/recommendation_typeController.js`
- `routes/recommendation_type.js`
- `views/recommendation_type/index.html` (or React/Vue components)
