...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/departments](https://digitalhr.cyclonenepal.com/admin/departments)
...
- **Department Name** (`dept_name`, type: text)
- **Department Head** (`dept_head_id`, type: select)
...
- `models/department.js` or equivalent
- `controllers/departmentController.js`
- `routes/department.js`
- `views/department/index.html` (or React/Vue components)
