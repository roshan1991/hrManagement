...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/general-settings](https://digitalhr.cyclonenepal.com/admin/general-settings)
...
- `models/general_settings.js` or equivalent
- `controllers/general_settingsController.js`
- `routes/general_settings.js`
- `views/general_settings/index.html` (or React/Vue components)
