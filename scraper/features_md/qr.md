...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/qr](https://digitalhr.cyclonenepal.com/admin/qr)
...
- `models/qr.js` or equivalent
- `controllers/qrController.js`
- `routes/qr.js`
- `views/qr/index.html` (or React/Vue components)
