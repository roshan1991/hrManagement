...
## Source URL
[https://digitalhr.cyclonenepal.com/admin/theme-color-setting](https://digitalhr.cyclonenepal.com/admin/theme-color-setting)
...
- **Primary Color** (`primary_color`, type: color)
- **Hover Color** (`hover_color`, type: color)
- **Dark Primary Color** (`dark_primary_color`, type: color)
- **Dark Hover Color** (`dark_hover_color`, type: color)
...
- `models/theme_color.js` or equivalent
- `controllers/theme_colorController.js`
- `routes/theme_color.js`
- `views/theme_color/index.html` (or React/Vue components)
